...
TOOLSETS = {
    ...
    "hermes-rabbit-r1": {
        "description": "Rabbit R1 bridge toolset - plain-text and voice-first messaging",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
